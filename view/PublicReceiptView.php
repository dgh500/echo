...
class PublicReceiptView extends View {
	...
	function LoadDefault($orderId) {
		$this->IncludeCss('PublicReceiptView.css.php');
...
EOT;
		...
		$this->mPage .= <<<EOT
				<tr>
					<td id="totalColHeading"><strong>Sub-Total:</strong><br /><strong>Delivery:</strong><br /><strong>Total:</strong></td>
...
} // End PublicReceiptView


/*if (isset ( $_GET ['orderId'] )) {
	$page = new PublicReceiptView ( );
